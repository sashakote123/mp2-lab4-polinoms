...
public:
	...
	void setTestPolinom(double value1, int degree1, double value2, int degree2);  //реализация аналогичная, как и в первом setPolinom, но полином состоит из двух мономов
	void printPolinom();
	~Polinoms() {};
